export default class AppointmentMasterDetailTemplate {
    ...
    static async renderTable(appointments) {
        return `<div class="row">
    ...
    <div class="table-responsive">
      <table class="table table-light table-bordered border-dark">
        ...
        <tbody>
          ...
          <td class="text-dark"><div>${appointment.getDescription() === ''
            ? 'N/A'
            : appointment.getDescription()}</div></td>
          <td class="text-dark"><div>${appointment.getNotes() === ''
            ? 'SIN ATENDER'
            : appointment.getNotes()}</div></td>
        </tr>
          `)
            .join('')}
        </tbody>
