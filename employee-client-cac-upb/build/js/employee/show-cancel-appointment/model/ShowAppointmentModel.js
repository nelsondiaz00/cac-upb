...
export default class ShowCancelAppointmentModel extends Subject {
    constructor() {
        super();
    }
    init = async () => {
    ...
    getAllAppointments = async () => {
        try {
            ...
            const appointments = responseData.map((data) => {
                ...
                return new Appointment(data.id, client, data.type, data.date, data.address, data.description);
            });
            return appointments;
        }
        catch (e) {
