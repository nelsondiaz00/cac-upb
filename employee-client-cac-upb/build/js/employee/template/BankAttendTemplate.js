export default class BankAttendTemplate {
    static async renderTurnNotifier(turn, state) {
        return `
        ...
        <form action="/" method="POST" class="form-employee">
          <div class="mb-3">
            <label for="appointment_type" class="form-label">Tipo</label>
              ...
              >
                  <option value="">Seleccione un tipo</option>
                  <option value="reclamos" ${ticket.getAppointment().getType() === 'reclamos'
            ? 'selected'
            : ''}>Reclamos</option>
                  <option value="devoluciones" ${ticket.getAppointment().getType() === 'devoluciones'
            ? 'selected'
            : ''}>Devoluciones</option>
                  <option value="asesoria" ${ticket.getAppointment().getType() === 'asesoria'
            ? 'selected'
          ...
          <div class="mb-3">
            ...
            <input
              ...
              class="form-control"
              placeholder="Fecha"
              value="${ticket.getAppointment().getDate().toISOString().split('T')[0]}"        
              readonly                
            />
          </div>
          <div class="mb-3">
            ...
            <select
                ...
                disabled
            >
                <option value="08:00" ${ticket.getAppointment().getDate().getHours() === 8
            ? 'selected'
            : ''}>8:00</option>
                <option value="09:00" ${ticket.getAppointment().getDate().getHours() === 9
            ? 'selected'
            : ''}>9:00</option>
                <option value="10:00" ${ticket.getAppointment().getDate().getHours() === 10
            ? 'selected'
            : ''}>10:00</option>
                <option value="11:00" ${ticket.getAppointment().getDate().getHours() === 11
            ? 'selected'
            : ''}>11:00</option>
                <option value="14:00" ${ticket.getAppointment().getDate().getHours() === 14
            ? 'selected'
            : ''}>14:00</option>
                <option value="15:00" ${ticket.getAppointment().getDate().getHours() === 15
            ? 'selected'
            : ''}>15:00</option>
                <option value="16:00" ${ticket.getAppointment().getDate().getHours() === 16
            ? 'selected'
            : ''}>16:00</option>
                <option value="17:00" ${ticket.getAppointment().getDate().getHours() === 17
            ? 'selected'
            : ''}>17:00</option>
            </select>
          </div>
          <div class="mb-3">
            ...
            >
                <option value="">Seleccione un lugar</option>
                <option value="cañaveral" ${ticket.getAppointment().getAddress() === 'cañaveral'
            ? 'selected'
            : ''}>Cañaveral</option>
            </select>
          </div>
