...
`;
  ...
  public static async renderAppointment(
          ...
          <form action="/" method="POST" class="w-50 m-auto mt-4 p-4">
              <div class="mb-3">
                  ...
                  >
                      ...
                      <option value="reclamos" ${
                        appointment.getType() === 'reclamos' ? 'selected' : ''
                      }>Reclamos</option>
                      <option value="devoluciones" ${
                        appointment.getType() === 'devoluciones'
                          ? 'selected'
                          : ''
                      }>Devoluciones</option>
                      <option value="asesoria" ${
                        appointment.getType() === 'asesoria' ? 'selected' : ''
              ...
              <div class="mb-3">
                  ...
                  <input
                      ...
                      placeholder="Fecha"
                      value="${
                        appointment.getDate().toISOString().split('T')[0]
                      }"
                  />
              </div>
              <div class="mb-3">
                  ...
                  >
                      <option value="08:00" ${
                        appointment.getDate().getHours() === 8 ? 'selected' : ''
                      }>8:00</option>
                      <option value="09:00" ${
                        appointment.getDate().getHours() === 9 ? 'selected' : ''
                      }>9:00</option>
                      <option value="10:00" ${
                        appointment.getDate().getHours() === 10
                          ? 'selected'
                          : ''
                      }>10:00</option>
                      <option value="11:00" ${
                        appointment.getDate().getHours() === 11
                          ? 'selected'
                          : ''
                      }>11:00</option>
                      <option value="14:00" ${
                        appointment.getDate().getHours() === 14
                          ? 'selected'
                          : ''
                      }>14:00</option>
                      <option value="15:00" ${
                        appointment.getDate().getHours() === 15
                          ? 'selected'
                          : ''
                      }>15:00</option>
                      <option value="16:00" ${
                        appointment.getDate().getHours() === 16
                          ? 'selected'
                          : ''
                      }>16:00</option>
                      <option value="17:00" ${
                        appointment.getDate().getHours() === 17
                          ? 'selected'
                          : ''
                      }>17:00</option>
                  </select>
              ...
              <div class="mb-3">
                  ...
                  >
                      ...
                      <option value="cañaveral" ${
                        appointment.getAddress() === 'cañaveral'
                          ? 'selected'
                          : ''
                      }>Cañaveral</option>
                  </select>
